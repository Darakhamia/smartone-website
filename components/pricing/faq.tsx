...
export function Faq() {
  ...
  const c = tr(
    lang,
    {
      ...
      talk: "Talk to us",
      faqs: [
        { q: "What's included in the price?", a: "Everything: the certified cash register and payment terminal, plus the Merchant Portal. No separate software subscription, no per-feature charges." },
        ...
        { q: "How fast can I start taking payments?", a: "Four business days or less from signing up to going live – including fiscal registration of the device for your market." },
    ...
    },
    {
      ...
      faqs: [
        { q: "¿Qué incluye el precio?", a: "Todo: la caja registradora certificada y el terminal de pago, más el Merchant Portal. Sin suscripción de software aparte ni cargos por función." },
        ...
        { q: "¿En cuánto tiempo puedo empezar a cobrar?", a: "En cuatro días hábiles o menos, desde el alta hasta estar operativo, incluida la registración fiscal del dispositivo para tu mercado." },
