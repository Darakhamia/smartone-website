        ...
        <div className="mt-11 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {industries.map((ind) => (
            <Link
              key={ind.title}
              href="/industries"
              className="group rounded-3xl bg-bg-2 p-4 transition-all duration-200 hover:-translate-y-1 hover:bg-brand-tint"
            >
              <div className="grid min-h-28 place-items-center rounded-2xl bg-white text-4xl">
                {ind.em}
              </div>
